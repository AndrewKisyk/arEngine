...
* Clone this project
* Create a symlink named `jniLibs` in `app/src/main` that points to `/Users/andrewkisyk/Library/Android/sdk/opencv-4.1.1-android-sdk/sdk/native/libs`
* In `app/CMakeLists.txt` change line 9 to points to `/Users/andrewkisyk/Library/Android/sdk/opencv-4.1.1-android-sdk/sdk/native/jni/include`
* Sync gradle
* Run the application
...
* Import OpenCV library module
  * New -> Import Module
  * Choose the `/Users/andrewkisyk/Library/Android/sdk/opencv-4.1.1-android-sdk/sdk/java` folder
...
* Make a symlink named `jniLibs` in `app/src/main` that points to `/Users/andrewkisyk/Library/Android/sdk/opencv-4.1.1-android-sdk/sdk/native/libs`
...
* Configure the `CMakeLists.txt` file
  * After the `cmake_minimum_required`, add
    ...
    ```
    include_directories(/Users/andrewkisyk/Library/Android/sdk/opencv-4.1.1-android-sdk/sdk/native/jni/include)
...
* Add OpenCV code
  * [MainActivity.java](app/src/main/java/com/android/arengiene/opencvnativeandroidstudio/MainActivity.java)
